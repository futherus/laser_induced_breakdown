...
%		Пороги для молекулярных газов выше, чем атомарных (из-за больших неупругих потерь, 1) на колебательные степени свободы, 2) низкие уровни возбуждения, которые сложно преодолеть).
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{res/break_air_1mus.jpg}
				\caption*{Интенсивность излучения от времени}
			\end{figure}	
			\column{0.5\linewidth}
			\begin{figure}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{res/break_spherical_1mus.jpg}
				\caption*{Интенсивность излучения от времени}
			\end{figure}	
			\column{0.5\linewidth}
			\begin{figure}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\begin{figure}
				\centering
				\includegraphics[width=1\linewidth]{res/break_water_500ns.jpg}
				\caption*{Интенсивность излучения от времени}
			\end{figure}	
			\column{0.5\linewidth}
			\begin{figure}
