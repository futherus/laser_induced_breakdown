...
\begin{document}
	...
	\begin{frame}
		...
		Отметим, что для фотонов не выполняется требование $\varepsilon_{\text{кол}} \approx 2.3\cdot 10^{-2} \text{ эВ} \gg h\nu = 1.8 \text{ эВ}$ (значения для рубинового лазера $\omega = 2.7 \cdot 10^{15} \text{ 1/с}, E \approx 10^7 \text{ В/см}$).
